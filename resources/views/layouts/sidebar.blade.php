<div class="nk-sidebar nk-sidebar-fixed is-dark " data-content="sidebarMenu">
    <div class="nk-sidebar-element nk-sidebar-head">
        <div class="nk-menu-trigger">
            <a href="{{route('index')}}" class="nk-nav-toggle nk-quick-nav-icon d-xl-none" data-target="sidebarMenu"><em class="icon ni ni-arrow-left"></em></a>
            <a href="{{route('index')}}" class="nk-nav-compact nk-quick-nav-icon d-none d-xl-inline-flex" data-target="sidebarMenu"><em class="icon ni ni-menu"></em></a>
        </div>
        ...
        <div class="nk-sidebar-content">
            <div class="nk-sidebar-menu" data-simplebar>
                <ul class="nk-menu">
                    ...
                    <li class="nk-menu-item">
                        <a href="{{route('admin.plan.index')}}" class="nk-menu-link">
                            <span class="nk-menu-icon"><em class="icon ni ni-dashlite"></em></span>
                            <span class="nk-menu-text">Planning </span>
                        </a>
                    </li><!-- .nk-menu-item -->
                    ...
                    <li class="nk-menu-item">
                        <a href="html/index-crypto.html" class="nk-menu-link">
                            ...
                            <span class="nk-menu-text">MyItems</span>
                        </a>
                    </li><!-- .nk-menu-item -->
                    <li class="nk-menu-item">
                    ...
                    @else
                        ...
                        @else
                    <li class="nk-menu-item">
                        <a href="{{route('admin.bank.index')}}" class="nk-menu-link">
                    ...
                    <li class="nk-menu-item">
                        <a href="{{route('admin.offer.index')}}" class="nk-menu-link">
                            <span class="nk-menu-icon"><em class="icon ni ni-list"></em></span>
                    ...
                    <li class="nk-menu-item">
                        <a href="{{route('admin.delivery.index')}}" class="nk-menu-link">
                            <span class="nk-menu-icon"><em class="icon ni ni-truck"></em></span>
                            <span class="nk-menu-text">Delivery</span>
                        </a>
                    </li>
                    <li class="nk-menu-item">
                        <a href="{{route('admin.telegram.index')}}" class="nk-menu-link">
                            <span class="nk-menu-icon"><em class="icon ni ni-telegram"></em></span>
                            <span class="nk-menu-text">Telegram</span>
                        </a>
                    </li>
                    <li class="nk-menu-heading">
                        <h6 class="overline-title text-primary-alt">Administation</h6>
                    </li><!-- .nk-menu-heading -->
                    
                    <li class="nk-menu-item">
                        <a href="{{route('admin.item.index')}}" class="nk-menu-link">
                            <span class="nk-menu-icon"><em class="icon ni ni-list"></em></span>
                            <span class="nk-menu-text">Items</span>
                        </a>
                    </li>
                    <li class="nk-menu-item">
                        <a href="{{route('admin.company.index')}}" class="nk-menu-link">
                    ...
                    <li class="nk-menu-item has-sub">
                        ...
                        <ul class="nk-menu-sub">
                            <li class="nk-menu-item">
                                <a href="html/project-card.html" class="nk-menu-link"><span class="nk-menu-text">Category</span></a>
                            </li>
                            <li class="nk-menu-item">
                                <a href="html/project-list.html" class="nk-menu-link"><span class="nk-menu-text">Items</span></a>
                            </li>
                        </ul><!-- .nk-menu-sub -->
                    </li><!-- .nk-menu-item -->
                    <li class="nk-menu-item has-sub">
                        ...
                        <ul class="nk-menu-sub">
                            <li class="nk-menu-item">
                                <a href="{{route('admin.company.index')}}" class="nk-menu-link"><span class="nk-menu-text">Companies</span></a>
                            </li>
                            <li class="nk-menu-item">
                                <a href="html/user-list-compact.html" class="nk-menu-link"><span class="nk-menu-text">Roles</span></a>
                            </li>
                            <li class="nk-menu-item">
